...
TEST(RulesTest, Rule3BaseOnly) {
  ...
  // Base penalty only: +1
  TripletContext triplet{
      60, 65, 69, Finger::kIndex, Finger::kThumb, Finger::kMiddle};
  EXPECT_DOUBLE_EQ(apply_rule_3(d, triplet), 1.0);
}
...
TEST(RulesTest, Rule3FullChange) {
  ...
  TripletContext triplet{
      60, 64, 72, Finger::kIndex, Finger::kThumb, Finger::kMiddle};
  EXPECT_DOUBLE_EQ(apply_rule_3(d, triplet), 2.0);
}
...
TEST(RulesTest, Rule3HalfChangeNotThumb) {
  ...
  TripletContext triplet{
      60, 64, 72, Finger::kIndex, Finger::kMiddle, Finger::kPinky};
  EXPECT_DOUBLE_EQ(apply_rule_3(d, triplet), 1.0);
}
...
TEST(RulesTest, Rule3Substitution) {
  ...
  TripletContext triplet{
      60, 64, 60, Finger::kIndex, Finger::kThumb, Finger::kMiddle};
  EXPECT_DOUBLE_EQ(apply_rule_3(d, triplet), 1.0);
}
...
TEST(RulesTest, Rule3BaseAndSubstitution) {
  ...
  TripletContext triplet{
      60, 64, 60, Finger::kThumb, Finger::kIndex, Finger::kMiddle};
  EXPECT_DOUBLE_EQ(apply_rule_3(d, triplet), 1.0);
}
...
TEST(RulesTest, Rule3NoPenalty) {
  ...
  TripletContext triplet{
      60, 62, 64, Finger::kThumb, Finger::kIndex, Finger::kThumb};
  EXPECT_DOUBLE_EQ(apply_rule_3(d, triplet), 0.0);
}
...
TEST(RulesTest, Rule12SameFingerReuse) {
  ...
  // middle
  TripletContext triplet1{
      60, 64, 68, Finger::kIndex, Finger::kThumb, Finger::kIndex};
  EXPECT_DOUBLE_EQ(apply_rule_12(triplet1), 1.0);
  // Same pitch: no penalty
  TripletContext triplet2{
      60, 64, 60, Finger::kIndex, Finger::kThumb, Finger::kIndex};
  EXPECT_DOUBLE_EQ(apply_rule_12(triplet2), 0.0);
  // Different fingers: no penalty
  TripletContext triplet3{
      60, 64, 68, Finger::kIndex, Finger::kThumb, Finger::kMiddle};
  EXPECT_DOUBLE_EQ(apply_rule_12(triplet3), 0.0);
  // Not monotonic: no penalty
  TripletContext triplet4{
      60, 70, 65, Finger::kIndex, Finger::kThumb, Finger::kIndex};
  EXPECT_DOUBLE_EQ(apply_rule_12(triplet4), 0.0);
}
